...
namespace iwa_console
{
    public class MyInformation
    {
        ...
        private string WebApiUrlSendMail { get { return $"{MicrosoftGraphBaseEndpoint}/v1.0/me/sendMail"; } }
        ...
        public async Task DisplayMeAndMyManagerAsync()
        {
            ...
            if (authenticationResult != null)
            {
                ...
                await CallWebApiAndSendEmailAsync(WebApiUrlSendMail, accessToken, "Send Email");
            }
        }
        ...
        private async Task CallWebApiAndSendEmailAsync(string url, string accessToken, string title)
        {
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine(title);
            Console.ResetColor();
            await protectedApiCallHelper.CallWebApiAndSendEmailAsync(url, accessToken, Display);
            Console.WriteLine();
        }
